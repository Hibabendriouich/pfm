            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow">
                    ...
                    <div class="text-center mt-4">
                        <a href="/team"> <img src="{{ asset('assets/images/mansouri.jpeg') }}" alt="Dr.Siham Ahmed Majid" class="rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
                        </a>
                       </div>
                    <!-- Details -->
                    <div class="card-body text-center">
                        <h5 class="card-title text-uppercase mb-1">Dr. Siham Mansouri</h5>
                        <p class="text-muted mb-3">Orthodontiste</p>
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            Dr. Siham Mansouri est une spécialiste en orthodontie, dédiée à transformer les sourires et améliorer la santé bucco-dentaire de ses patients. Après avoir obtenu son diplôme en chirurgie dentaire à [Nom de l’université], il/elle s’est spécialisée en orthodontie à [Nom de l’université ou de l’institut], acquérant des compétences avancées dans la correction des malpositions dentaires et des mâchoires.

Avec une expérience de plus de [X années] dans le domaine, Dr. Siham Mansouri propose des solutions adaptées à tous les âges, allant des enfants aux adultes, en utilisant des techniques modernes et efficaces telles que :

Les appareils dentaires fixes traditionnels.
Les aligneurs transparents (type Invisalign®).
Les appareils fonctionnels pour les enfants.
Les traitements de rééducation des mâchoires.
Les dispositifs de contention pour maintenir les résultats sur le long terme.
Passionnée par son métier, Dr. Siham Mansouri met un point d’honneur à offrir une prise en charge personnalisée, dans une ambiance conviviale et rassurante. Son approche est centrée sur la compréhension des besoins spécifiques de chaque patient, afin de concevoir des plans de traitement sur mesure qui allient esthétique et fonctionnalité.

Toujours en quête d’innovation, Dr. Siham Mansouri participe régulièrement à des séminaires et formations pour maîtriser les dernières avancées technologiques en orthodontie. Sa rigueur professionnelle et son engagement envers l’excellence ont permis à de nombreux patients de retrouver la confiance en leur sourire.
                        </p>
                    </div>
                    ...
                    <div class="card-footer bg-light text-center">
                        ...
                        <p class="mb-1"><i class="fas fa-envelope"></i> siham@gmail.com</p>
                        <p class="mb-0"><i class="fas fa-globe"></i> www.siham.com</p>
                    </div>
                </div>
            </div>
        </div>
