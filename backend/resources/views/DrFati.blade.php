            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title text-uppercase mb-1">Dr. Fatimaezzahra Kabiri</h5>
                        <p class="text-muted mb-3">Dentiste généraliste</p>
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            Dr. Fatimaezzahra Kabiri est un dentiste généraliste expérimenté, dédié à offrir des soins dentaires complets et personnalisés à des patients de tous âges. Diplômé(e) de [Nom de l’université ou de l’institut], il/elle exerce avec passion et professionnalisme depuis [X années], aidant ses patients à maintenir une santé bucco-dentaire optimale.

Spécialisé(e) dans les soins préventifs, diagnostiques et curatifs, Dr. Fatimaezzahra Kabiri propose une large gamme de services, notamment :

Les consultations de routine et bilans dentaires.
Le détartrage et le polissage pour une hygiène bucco-dentaire impeccable.
Les soins des caries et restaurations esthétiques.
Les extractions dentaires, y compris les dents de sagesse.
La conception et la pose de prothèses dentaires (fixes ou amovibles).
Le traitement des affections des gencives, comme la gingivite ou la parodontite.
Toujours à l’écoute de ses patients, Dr. Fatimaezzahra Kabiri s’efforce de rendre chaque visite au cabinet aussi agréable que possible, en adoptant une approche empathique et en expliquant chaque étape des soins. Conscient(e) que la santé bucco-dentaire est essentielle à la santé générale, il/elle met un point d’honneur à sensibiliser ses patients sur les meilleures pratiques d’hygiène et les traitements disponibles.

En parallèle de son activité clinique, Dr. Fatimaezzahra Kabiri participe régulièrement à des formations continues et des conférences afin de rester à la pointe des innovations dans le domaine dentaire. Son engagement envers l’excellence et sa capacité à s’adapter aux besoins spécifiques de chaque patient font de lui/elle un(e) professionnel(le) de confiance dans la communauté.

En dehors du cabinet, Dr. Fatimaezzahra Kabiri est passionné(e) par [mentionner un loisir ou une activité personnelle, par ex. "le sport", "les voyages" ou "la photographie"], ce qui contribue à son équilibre personnel et professionnel. </p>
                    </div>
                    <!-- Formation & Expérience Section -->
                    <div class="card-body">
                        <h5 class="card-title text-center">Formation & Expérience</h5>
                        <ul>
                            <li><strong>Formation :</strong>Diplôme Universitaire de Chirurgie Orale et Implantologie: Faculté de Médecine et Pharmacie de Casablanca                             
                            </li>
                            <p>Certificat d’Anatomie Chirurgicale Appliquée: Faculté de Médecine Saint Pèreparis 5
                            </p>  
                            
                            <li><strong>Expérience :</strong> Ex interne au CHU de Casablanca.</li>
                    ...
                    <div class="card-body">
                        ...
                        <ul>
                            <li><strong>Implants Dentaires :</strong> Pose d'implants dentaires pour remplacer les dents manquantes, en utilisant des techniques modernes et minimisant l'inconfort.</li>
                            <li><strong>Chirurgie Orale :</strong> Traitement des problèmes buccaux complexes, y compris l'extraction des dents de sagesse et la correction des anomalies dentaires.</li>
                            <li><strong>Augmentation Osseuse :</strong> Techniques d'augmentation osseuse pour préparer la mâchoire à recevoir des implants dentaires.</li>
                            <li><strong>Régénération Osseuse :</strong> Traitement des défauts osseux afin de restaurer la fonction et l'apparence de la mâchoire.</li>
                            <li><strong>Chirurgie Parodontale :</strong> Traitement des maladies des gencives pour prévenir la perte de dents et améliorer la santé bucco-dentaire.</li>
                        </ul>
                    </div>
                    ...
                    <div class="card-footer bg-light text-center">
                        ...
                        <p class="mb-1"><i class="fas fa-envelope"></i> fati@gmail.com</p>
                        <p class="mb-0"><i class="fas fa-globe"></i> www.fati.com</p>
                    </div>
                </div>
            </div>
        </div>
