...
<body>
            ...
            <div class="row gx-0">
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary d-flex flex-column p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Heures d'ouverture:</h3><br>
                        <div class="d-flex justify-content-between text-white mb-3">
                            <h6 class="text-white mb-0">Lundi - Vendredi</h6>
                            <p class="mb-0"> 8h00 - 20h00</p>
                        </div>
                        <div class="d-flex justify-content-between text-white mb-3">
                ...
                <div class="col-lg-4 wow zoomIn " data-wow-delay="0.3s">
                    <div class="bg-dark d-flex flex-column p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Chercher un médecin</h3>
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
                    <div class="bg-secondary d-flex flex-column p-5" style="height: 300px;">
                        ...
                        <p class="text-white">Que ce soit pour un contrôle de routine, un blanchiment dentaire, ou une intervention plus complexe, nous mettons à votre disposition les dernières technologies pour garantir des résultats optimaux. </p>
                        <h4 class="text-white mb-0"><a href="tel:+212 534999999" style="color: rgba(9, 30, 62, .85);">+212 534999999</a></h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title mb-4">
                        <h5 class="position-relative d-inline-block text-primary text-uppercase">A propos de nous</h5>
                        <h1 class="display-5 mb-0">La clinique dentaire en qui vous pouvez avoir confiance, pour un sourire éclatant et durable.</h1>
                    </div>
                    <h4 class="text-body fst-italic mb-4">Votre sourire, notre mission.</h4>
                    <p class="mb-4">Bienvenue chez H&F
                        Votre sourire est notre priorité. Nous offrons des soins dentaires complets et personnalisés pour toute la famille, dans un cadre moderne et chaleureux. Notre équipe de professionnels expérimentés est à votre écoute pour vous accompagner dans le maintien d’une bonne santé bucco-dentaire, de la prévention aux traitements spécialisés. Que ce soit pour un contrôle de routine, un blanchiment dentaire, ou une intervention plus complexe, nous mettons à votre disposition les dernières technologies pour garantir des résultats optimaux. Prenez soin de votre sourire avec des experts dédiés à votre bien-être.</p>
                    <div class="row g-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                            <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Primé</h5>
                            <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Staff Professionnel</h5>
                        </div>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="{{ asset('assets/images/about.jpg') }}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 wow zoomIn" data-wow-delay="0.6s">
                    <div class="offer-text text-center rounded p-5">
                        <h1 class="display-5 text-white">Actualités</h1>
    ...
    <!-- Testimonial Start -->
    <div id="avis" class="container  mb-2 wow fadeInUp" data-wow-delay="0.1s" style="margin-top: 90px;">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel rounded p-5 wow zoomIn" data-wow-delay="0.6s">
                        <div class="testimonial-item text-center text-white">
                            <img class="img-fluid mx-auto rounded mb-4" src="{{ asset('assets/images/icho.jpeg') }}" alt="">
                            <p class="fs-5">Une clinique que je vous recommande,tout y est la gentillesse la politesse le respect et des soins de qualité j’ajouterais que les médecins sont très à l’écoute, ils explique tous leurs gestes, de bonnes conditions d’hygiène, ainsi que d’excellent résultat après chaque traitement, je vous souhaite une très bonne continuation et plein de réussite.</p>
                            <hr class="mx-auto w-25">
                            <h4 class="text-white mb-0">R.Ichou</h4>
                        </div>
                        <div class="testimonial-item text-center text-white">
                            <img class="img-fluid mx-auto rounded mb-4" src="{{ asset('assets/images/testimonial-1.jpg') }}" alt="">
                            <p class="fs-5">J étais honorée de faire partie des premiers patients de la clinique. Une équipe jeune compétente et très chaleureuse..un travail de professionnel et un sens de détail hors du commun. Mes profonds remerciements à Dr Jaafari pour son excellent travail..très bonne continuation.</p>
                            <hr class="mx-auto w-25">
                            <h4 class="text-white mb-0">Sanae</h4>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Newsletter End -->
    ...
    <!-- Footer Start -->
    <div id="contact" class="container-fluid bg-dark text-light py-5 wow fadeInUp" data-wow-delay="0.3s" style="margin-top: -75px;">
...
searchBtn.addEventListener("click", () => {
    ...
    const selectedPage = serviceSelect.value;
    if (selectedPage) {
