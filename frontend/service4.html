        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 wow zoomIn" data-wow-delay="0.6s">
                <div class="offer-text text-center rounded p-5">
                    <h1 class="display-5 text-white">Dr. Oubeid Allah Hlal</h1>
                    <h3><strong><u>Dentiste chirurgien</u></strong></h3>
                    <img src="./img/oubeid.webp"/ style="height: 300px; width: 300px">
